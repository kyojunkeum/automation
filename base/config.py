...
SERVICE_NAME_NAVERWORKS_MAIL_FILE_KO = "네이버웍스"
SERVICE_NAMES_NAVERWORKS_MAIL = [
    SERVICE_NAME_NAVERWORKS_MAIL_KO,
    SERVICE_NAME_NAVERWORKS_MAIL_EN,
    SERVICE_NAME_NAVERWORKS_MAIL_FILE_KO,
]

SERVICE_NAME_NAVERWORKS_MEMO_KO = "네이버웍스 메모"
SERVICE_NAME_NAVERWORKS_MEMO_EN = "NaverWorks-Memo"
SERVICE_NAME_NAVERWORKS_MEMO_FILE_KO = "네이버웍스"
SERVICE_NAMES_NAVERWORKS_MEMO = [
    SERVICE_NAME_NAVERWORKS_MEMO_KO,
    SERVICE_NAME_NAVERWORKS_MEMO_EN,
    SERVICE_NAME_NAVERWORKS_MEMO_FILE_KO,
]

# ============================
# 서비스 이름 (MESSENGER)
# ============================
SERVICE_NAME_DOORAY_MESSENGER_KO = "두레이 메신저"
SERVICE_NAME_DOORAY_MESSENGER_EN = "Dooray Messenger"
...
SERVICE_NAME_DOORAY_BOARD_EN = "Dooray Board"
...
SERVICE_NAME_DOORAY_CALENDAR_EN = "Dooray Calendar"
...
SERVICE_NAME_DOORAY_WIKI_KO = "두레이 위키"
SERVICE_NAME_DOORAY_WIKI_EN = "Dooray Wiki"
SERVICE_NAMES_DOORAY_WIKI = [
    SERVICE_NAME_DOORAY_WIKI_KO,
    SERVICE_NAME_DOORAY_WIKI_EN,
]
...
SERVICE_NAME_DOORAY_BOARD_COMMENT_EN = "Dooray Board"
SERVICE_NAMES_DOORAY_BOARD_COMMENT = [
    SERVICE_NAME_DOORAY_BOARD_COMMENT_KO,
    SERVICE_NAME_DOORAY_BOARD_COMMENT_EN,
]

SERVICE_NAME_DOORAY_WIKI_COMMENT_KO = "두레이 위키-댓글"
SERVICE_NAME_DOORAY_WIKI_COMMENT_EN = "Dooray Wiki"
SERVICE_NAMES_DOORAY_WIKI_COMMENT = [
    SERVICE_NAME_DOORAY_WIKI_COMMENT_KO,
    SERVICE_NAME_DOORAY_WIKI_COMMENT_EN,
]

SERVICE_NAME_NAVERWORKS_BOARD_COMMENT_KO = "네이버웍스 게시판"
SERVICE_NAME_NAVERWORKS_BOARD_COMMENT_EN = "NaverWorks Board"
SERVICE_NAMES_NAVERWORKS_BOARD_COMMENT = [
    SERVICE_NAME_NAVERWORKS_BOARD_COMMENT_KO,
...
SERVICE_NAME_DOORAY_TASK_EN = "Dooray Tasks"
...
SERVICE_NAME_DOORAY_DRIVE_EN = "Dooray Drive"
