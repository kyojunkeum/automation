...
def test_compare_result_naverworks_board_comment():
    with sync_playwright() as p:
        ...
        try:
            ...
            test_cases = [
                {"row_index": 21, "expected": {"pattern_count": "0", "keyword_count": "0", "file_count": "0"}},  # 일반 로깅
                {"row_index": 19, "expected": {"pattern_count": "1", "keyword_count": "0", "file_count": "0"}},  # 개인정보 로깅
                {"row_index": 15, "expected": {"pattern_count": "0", "keyword_count": "1", "file_count": "0"}},  # 키워드 로깅
