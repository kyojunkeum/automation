...
def test_naver_normal_send(request):
    with sync_playwright() as p:
        ...
        try:
            ...
            # 보내기 성공 여부 확인
            page.wait_for_selector("text=메일이 저장되었습니다", timeout=10000)
            assert page.locator("text=메일이 저장되었습니다").is_visible(), "보내기에 실패했습니다."
            ...
            screenshot_path = os.path.join("screenshot", f"screenshot_normal_passed_{timestamp}.png")
