...
def test_naverworks_messenger_normal(request):
    with sync_playwright() as p:
        ...
        try:
            ...
            # 실패 시 스크린샷 경로 설정
            screenshot_path = get_screenshot_path("test_naverworks_messenger_normal")  # 공통 함수 호출
            page.screenshot(path=screenshot_path, type="jpeg", quality=80)
            # page.screenshot(path=screenshot_path, full_page=True)
            print(f"Screenshot taken at : {screenshot_path}")
            allure.attach.file(screenshot_path, name="naverworks_messenger_normal_failure_screenshot", attachment_type=allure.attachment_type.JPG)
...
def test_naverworks_messenger_pattern(request):
    with sync_playwright() as p:
        ...
        try:
            ...
            # 실패 시 스크린샷 경로 설정
            screenshot_path = get_screenshot_path("test_naverworks_messenger_pattern")  # 공통 함수 호출
            page.screenshot(path=screenshot_path, type="jpeg", quality=80)
            # page.screenshot(path=screenshot_path, full_page=True)
            print(f"Screenshot taken at : {screenshot_path}")
            allure.attach.file(screenshot_path, name="naverworks_messenger_pattern_failure_screenshot", attachment_type=allure.attachment_type.JPG)
...
def test_naverworks_messenger_keyword(request):
    with sync_playwright() as p:
        ...
        try:
            ...
            # 실패 시 스크린샷 경로 설정
            screenshot_path = get_screenshot_path("test_naverworks_messenger_keyword")  # 공통 함수 호출
            page.screenshot(path=screenshot_path, type="jpeg", quality=80)
            # page.screenshot(path=screenshot_path, full_page=True)
            print(f"Screenshot taken at : {screenshot_path}")
            allure.attach.file(screenshot_path, name="naverworks_messenger_keyword_failure_screenshot", attachment_type=allure.attachment_type.JPG)
...
def test_naverworks_messenger_attach(request):
    with sync_playwright() as p:
        ...
        try:
            ...
            # 실패 시 스크린샷 경로 설정
            screenshot_path = get_screenshot_path("test_naverworks_messenger_attach")  # 공통 함수 호출
            page.screenshot(path=screenshot_path, type="jpeg", quality=80)
            # page.screenshot(path=screenshot_path, full_page=True)
            print(f"Screenshot taken at : {screenshot_path}")
            allure.attach.file(screenshot_path, name="naverworks_messenger_attach_failure_screenshot", attachment_type=allure.attachment_type.JPG)
